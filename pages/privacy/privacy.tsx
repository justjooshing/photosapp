...
import { H1, H2, H3, LegalText } from "@/tamagui/variants";
...
const PrivacyPolicy = () => (
  <ScrollView style={{ paddingHorizontal: 20 }}>
    ...
    <LegalText>
      ...
      our app to sort through your photos stored on your Google Photos account.
    ...
    <LegalText>
      ...
      <LegalText style={{ fontWeight: "bold" }}>
        However, we will never use your personal data for advertising purposes.
      </LegalText>{" "}
    ...
    <H2>Data Security</H2>
    <LegalText>
      We are committed to protecting your information. We implement a variety of
    ...
    <LegalText>
      ...
      in operating our app, conducting our business, or servicing you, so long
      as those parties agree to keep this information confidential.
    </LegalText>

    <H2>Account Deletion</H2>
    <LegalText>
      You can permanently delete your account at any time from within the app or
      by emailing us at{" "}
      <LegalText style={{ fontWeight: "bold" }}>
    ...
    <H2>Your Consent</H2>
    <LegalText>By using our app, you consent to our Privacy Policy.</LegalText>
    ...
    <LegalText>
      ...
      when using this app, then you can be assured that it will only be used in
